"""
Specific tests for guardrail behavior to ensure only technical support and customer service tasks are allowed
"""
import pytest
...
async def test_anonymous_can_only_access_customer_service_tools():
    ...
    tools = [
        ...
        {"name": "get_customer", "description": "", "inputSchema": {"type": "object"}},  # Admin only
        {"name": "system_config", "description": "", "inputSchema": {"type": "object"}},  # Admin only
        {"name": "admin_stats", "description": "", "inputSchema": {"type": "object"}},    # Admin only
        {"name": "delete_user", "description": "", "inputSchema": {"type": "object"}},   # Admin only
        {"name": "modify_pricing", "description": "", "inputSchema": {"type": "object"}}, # Admin only
    ]
    ...
    assert anonymous_names == expected_customer_service, \
        f"Anonymous principal sees wrong tools. Got: {anonymous_names}, Expected: {expected_customer_service}"
...
async def test_customer_can_only_access_customer_service_tools():
    ...
    assert customer_names == expected_customer_service, \
        f"Customer principal sees wrong tools. Got: {customer_names}, Expected: {expected_customer_service}"
...
async def test_guardrail_prevents_unmapped_tools_for_non_staff():
    ...
    tools = [
        {"name": "list_products", "description": "", "inputSchema": {"type": "object"}},  # Mapped to anonymous
        {"name": "mystery_tool", "description": "", "inputSchema": {"type": "object"}},   # Not mapped - should default to staff
    ]
